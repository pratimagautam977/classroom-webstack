...
import {
  ...
  GetTasks,
  DeleteTask,
} from "../../components/calendar/CalendarFunction";
import EditTaskModal from "../../components/calendar/EditTask";

moment.locale("en-GB");
const localizer = momentLocalizer(moment);

export default class InstituteCalendar extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = (e) => {
    ...
    AddTask(task, "institute").then((res) => {
      console.log(res);
      GetTasks("institute").then((res) => {
  ...
  DeleteATask = (id) => {
    DeleteTask(id, "institute").then((res) => {
      console.log(res);
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <AddTaskModal body={bodymsg} title={"Add Task"} btn={"+ Add Task"} />
                  ...
                  <div className="col-12" key={task.id}>
                    <div className="row">
                      <div className="col-8">
                        ...
                        <p className="f-12">
                          {"Start On: " +
                            moment(task.start).format("YYYY-MM-DD kk:mm")}
                        </p>
                        <p className="f-12">
                          {"End At: " +
                            moment(task.end).format("YYYY-MM-DD kk:mm")}
                        </p>
                        <p></p>
                      </div>
                      <div className="col-4">
                        ...
                        <button
                          className="button_table"
                          style={{ fontSize: "15px" }}
                          onClick={() => this.DeleteATask(task.id)}
                        >
