...
import { GetStudent, UpdateStudent } from "./StudentFunction";

export default class EditStudentModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      editData: {},
  ...
  onSubmit = e => {
    ...
    UpdateStudent(editData, this.props.id).then(res => {
      console.log(res);
      this.props.toggle()
  ...
  componentDidMount() {
    ...
    GetStudent(id).then(res => {
      console.log(res);
      const editData = res.data.student;
      this.setState({ editData });
    });
  }
